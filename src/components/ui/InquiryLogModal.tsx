      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-4xl h-[90vh] md:h-[80vh] bg-surface/95 backdrop-blur-2xl border border-white/10 overflow-hidden z-10 flex flex-col shadow-2xl"
          >
            {/* Header */}
            <div className="p-6 border-b border-white/10 flex justify-between items-center bg-white/[0.02]">
              ...
              <button
                onClick={onClose}
                className="p-1.5 border border-white/10 bg-white/5 hover:border-white/20 text-on-surface-variant hover:text-on-surface transition-all cursor-pointer"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="flex-1 flex flex-col md:flex-row overflow-hidden bg-transparent">
              ...
              <div className="w-full md:w-80 border-r border-white/5 flex flex-col bg-white/[0.02] overflow-y-auto">
                <div className="p-4 border-b border-white/5">
                  <form onSubmit={handleSearch} className="relative">
                    <input
                      ...
                      className="w-full bg-white/[0.04] border border-white/10 px-3.5 py-2 pr-9 font-mono text-[10px] uppercase text-on-surface placeholder:text-on-surface-variant/50 outline-none focus:border-secondary"
                    />
                    ...
                    {inquiries.map((inq) => {
                      ...
                      return (
                        <div
                          ...
                          className={`p-4 cursor-pointer text-left transition-colors ${isActive ? 'bg-secondary/10 border-l-2 border-secondary' : 'hover:bg-white/[0.03]'
                            }`}
                        >
              ...
              <div className="flex-1 overflow-y-auto p-6 sm:p-8 flex flex-col justify-between">
                {activeInquiry ? (
                  <div className="space-y-6">
                    ...
                    <div className="bg-white/[0.03] p-4 border border-white/5 rounded-none font-sans text-xs space-y-2">
                      ...
                      <div className="text-on-surface-variant font-light space-y-1">
                        ...
                        <p className="italic bg-white/[0.04] border border-white/5 p-2 mt-2 leading-relaxed text-on-surface-variant">
                ...
                {/* Footer notes */}
                {activeInquiry && (
                  <div className="border-t border-white/5 pt-4 mt-6 text-[10px] font-sans text-on-surface-variant/50 flex justify-between items-center">
